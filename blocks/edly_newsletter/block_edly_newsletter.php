                            ...
                            <div class="subscribe-content">
                                ...
                                if($this->content->action_url):
                                    ...
                                    <form action="'.$this->content->action_url.'" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="newsletter-form validate" target="_blank">
                                        <input type="text" value="" name="EMAIL" class="email input-newsletter" id="mce-EMAIL" placeholder="'.$this->content->placeholder.'" required>
                                        <button type="submit" name="subscribe" id="mc-embedded-subscribe" class="button default-btn">'.format_text($this->content->btn).'</button>
                                    </form>';
                                endif;
                                $text .= '
                            </div>
