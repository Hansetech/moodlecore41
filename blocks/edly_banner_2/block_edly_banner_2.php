                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="main-banner-wrap-content">
                            <h1 data-aos="fade-right" data-aos-delay="70" data-aos-duration="700" data-aos-once="true">'.format_text($title).'</h1>
                            <p data-aos="fade-right" data-aos-delay="80" data-aos-duration="800" data-aos-once="true">'.format_text($body).'</p>
                            <ul class="banner-btn" data-aos="fade-right" data-aos-delay="90" data-aos-duration="900" data-aos-once="true">';
                                if($button_text):
                                    $text .='
                                    <li>
                                        <a href="'.$button_link.'" class="default-btn">'.format_text($button_text).'</a>
                                    </li>';
                                endif;
                                ...
                                if($right_button_text):
                                    $text .='
                                    <li>
                                        <a href="'.$right_button_link.'" class="default-btn">'.format_text($right_button_text).'</a>
                                    </li>';
                                endif;
                                $text .='
                            </ul>
                        ...
                        <div class="main-banner-wrap-image" data-aos="fade-left" data-aos-delay="80" data-aos-duration="800" data-aos-once="true">';
                            ...
                            $text .= '
                                <div class="banner-box" data-aos="fade-left" data-aos-delay="120" data-aos-duration="1200" data-aos-once="true">
                                    <div class="info d-flex align-items-center">';
                                        ...
                                        <div class="title">
                                            <span>'.format_text($info_card1_top_title).'</span>
                                        </div>
                                    </div>
                                    <h3>
                            ...
                            $text .= '
                                <div class="banner-congratulations" data-aos="fade-left" data-aos-delay="140" data-aos-duration="1400" data-aos-once="true">
                                    <div class="content">';
                                        ...
                                        <h3>'.format_text($info_card2_title).'</h3>
                                        <p>'.format_text($info_card2_content).'</p>
                                    </div>
                                </div>';
                            endif;
                            ...
                            $text .= '
                                <div class="banner-reviews" data-aos="fade-left" data-aos-delay="150" data-aos-duration="1500" data-aos-once="true">
                                    <span><i class="'.format_text($info_card3_icon).'"></i> '.format_text($info_card3_content).'</span>
                                    <h3>
                                    '.format_text($info_card2_title).'
                                    </h3>
                                </div>';
                            endif; 
                            $text .= '
