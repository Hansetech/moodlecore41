                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-6 col-md-12" data-aos="fade-up" data-aos-delay="70" data-aos-duration="700" data-aos-once="true">
                        <div class="career-content">
                            ...
                            '.format_text($this->content->content).'
                        </div>
                    </div>
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div class="career-funfacts-card">
                                        <div class="content">
                                            ...
                                            <h3><span class="odometer" data-count="'.$funfacts_number.'">00</span><span class="sign">'.format_text($funfacts_prefix).'</span></h3>
                                            <p>'.format_text($funfacts_title).'</p>
                                        </div>
                                    </div>
                                </div>';
                            } 
                            ...
                            $text .= '
                                <div class="col-lg-12 col-md-12">
                                    <div class="career-bottom-content">
                                        <h3>'.format_text($this->content->bottom_title).'</h3>
                                    </div>
                                </div>';
                            endif;
                            $text .='
