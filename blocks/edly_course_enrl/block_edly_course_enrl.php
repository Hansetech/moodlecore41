        ...
        <div class="courses-details-info">
            ...
            <div class="content">';
                if($this->content->price){
                    if (is_enrolled($context, $USER, '', true)) {
                        ...
                        <div class="price">
                            ...
                            <p>'.format_text($this->content->price).'</p>
                        </div>';
                    }else{ $text .='
                        <div class="price">
                            '.$this->content->free.'
                ...
                if(!$edlyCourse->course_is_enrolled):
                    $text .='
                    <div class="btn-box">
                        <a href="'. $edlyCourse->enrolmentLink .'" class="default-btn">'.format_text( get_string('course_enrolment', 'theme_edly') ).'</a>
                    </div>';
                endif;
                $text .='
                ...
                <ul class="info">';	
                    ...
                    <li>
                        <div class="d-flex justify-content-between align-items-center">
                            <span><i class="'.format_text($item_icon, FORMAT_HTML, array('filter' => true)).'"></i> '.format_text($item_title, FORMAT_HTML, array('filter' => true)).'</span>
