                                        ...
                                        <div class="courses-box">
                                            <div class="courses-image">
                                                ...
                                                if($edlyCourse->course_price) {
                                                    $text .= '
                                                    <div class="price">'.format_text(get_config('theme_edly', 'site_currency') .''.$edlyCourse->course_price).'</div>';
                                                }else{
                                                    $text .= '
                                                    <div class="price">'.format_text(get_config('theme_edly', 'free_course_price') ).'</div>';
                                                } $text .= '
                                            </div>
                                            ...
                                            <div class="courses-content">
                                                ...
                                                <h3>
                                                    <a href="'. $edlyCourse->url .'">'.format_text($edlyCourse->fullName).'</a>
                                                </h3>
                                                <div class="bottom-list d-flex justify-content-between align-items-center">
                                                    <p>'.format_text($edlyCourseDescription).'</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>';
