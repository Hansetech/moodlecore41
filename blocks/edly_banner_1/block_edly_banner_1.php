        ...
        <div class="main-banner-area">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-7 col-md-12">
                        <div class="main-banner-content">
                            <h1 data-aos="fade-right" data-aos-delay="70" data-aos-duration="700" data-aos-once="true">'.format_text(format_text($this->content->title)).'</h1>
                            <p data-aos="fade-right" data-aos-delay="80" data-aos-duration="800" data-aos-once="true">'.format_text(format_text($this->content->body)).'</p>';
                            ...
                            if($this->content->search_placeholder):
                                ...
                                <form class="banner-search" data-aos="fade-right" data-aos-delay="90" data-aos-duration="900" data-aos-once="true" action="'.$url->out().'">
                                    ...
                                    <input type="text" name="q" class="input-search" placeholder="'.format_text($this->content->search_placeholder, FORMAT_HTML).'">';

                                    if($this->content->search_btn):
                                        $text .='
                                        <button type="submit" class="default-btn">'.format_text(format_text($this->content->search_btn)).'</button>';
                                    endif;
                                        $text .='
                                </form>';
                            endif;
            ...
            if($this->content->bottom_title):
                ...
                <div class="main-banner-bottom-content">
                    <h3>'.format_text(format_text($this->content->bottom_title)).'</h3>
                </div>';
            endif;
            $text .= '
        </div>';
